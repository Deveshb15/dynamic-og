...
export const getServerSideProps = async ({ query }) => {
	...
	let img_url =
		data?.avatar_url ?? "https://avatars.githubusercontent.com/u/72264218?v=4";
	let username = data?.login ?? "Deveshb15";
	return {
		props: {
			name,
			bio,
...
const GithubUser = ({ name, bio, img_url, username }) => {
	return (
		<div>
			<Head>
				<title>{name}</title>
				<meta
					name="description"
					content="Dynamic Github OG based on your username"
				/>
